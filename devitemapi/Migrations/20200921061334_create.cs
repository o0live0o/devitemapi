        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DevMenuActions_DevMenus_MenuId",
                        column: x => x.MenuId,
                        principalTable: "DevMenus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("557b25cc-463d-4116-9d7d-5003d6acbf6a"), new DateTime(2020, 9, 21, 14, 13, 34, 500, DateTimeKind.Local).AddTicks(3452), new DateTime(2020, 9, 21, 14, 13, 34, 500, DateTimeKind.Local).AddTicks(3474), "SuperAdmin", "超级管理员", 1 },
                    { new Guid("78d6d23b-64c1-4d23-b766-a19276be3d1c"), new DateTime(2020, 9, 21, 14, 13, 34, 500, DateTimeKind.Local).AddTicks(3536), new DateTime(2020, 9, 21, 14, 13, 34, 500, DateTimeKind.Local).AddTicks(3538), "Admin", "管理员", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("bc9e5615-17d5-4ca2-adf9-200f903e0a7d"), "Administrator", null, new DateTime(2020, 9, 21, 14, 13, 34, 499, DateTimeKind.Local).AddTicks(1090), null, new DateTime(2020, 9, 21, 14, 13, 34, 499, DateTimeKind.Local).AddTicks(1423), null, "123456", 1, "超级管理员" });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "ActionId", "CreateDate", "MenuId", "ModifyDate", "RoleId" },
                values: new object[,]
                {
                    { new Guid("c9372ae7-ebd4-4c4b-9e64-f55965d35e78"), new Guid("7b48a7f0-4077-4c1e-acd5-87ef0a8ace93"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("19b93b25-5230-425b-b5c5-625b708915b5"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("557b25cc-463d-4116-9d7d-5003d6acbf6a") },
                    ...
                    { new Guid("e55c31ba-e4fc-4682-a4ad-b5eee06d2b3b"), new Guid("532e849c-b3d5-4d55-abfe-6e645ba2bae2"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("daf50ad9-c46b-43de-aab2-ca4418785ba3"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("557b25cc-463d-4116-9d7d-5003d6acbf6a") },
