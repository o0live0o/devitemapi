...
{
    public partial class _20200914 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("557b25cc-463d-4116-9d7d-5003d6acbf6a"), new DateTime(2020, 9, 14, 17, 52, 57, 18, DateTimeKind.Local).AddTicks(3519), new DateTime(2020, 9, 14, 17, 52, 57, 18, DateTimeKind.Local).AddTicks(3542), "SuperAdmin", "超级管理员", 1 },
                    { new Guid("78d6d23b-64c1-4d23-b766-a19276be3d1c"), new DateTime(2020, 9, 14, 17, 52, 57, 18, DateTimeKind.Local).AddTicks(3619), new DateTime(2020, 9, 14, 17, 52, 57, 18, DateTimeKind.Local).AddTicks(3620), "Admin", "管理员", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("bc9e5615-17d5-4ca2-adf9-200f903e0a7d"), "Administrator", null, new DateTime(2020, 9, 14, 17, 52, 57, 17, DateTimeKind.Local).AddTicks(983), null, new DateTime(2020, 9, 14, 17, 52, 57, 17, DateTimeKind.Local).AddTicks(1328), null, "123456", 1, "超级管理员" });
