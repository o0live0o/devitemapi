...
{
    public partial class _2020091508 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("557b25cc-463d-4116-9d7d-5003d6acbf6a"), new DateTime(2020, 9, 15, 8, 54, 8, 350, DateTimeKind.Local).AddTicks(6816), new DateTime(2020, 9, 15, 8, 54, 8, 350, DateTimeKind.Local).AddTicks(7001), "SuperAdmin", "超级管理员", 1 },
                    { new Guid("78d6d23b-64c1-4d23-b766-a19276be3d1c"), new DateTime(2020, 9, 15, 8, 54, 8, 350, DateTimeKind.Local).AddTicks(7088), new DateTime(2020, 9, 15, 8, 54, 8, 350, DateTimeKind.Local).AddTicks(7089), "Admin", "管理员", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("bc9e5615-17d5-4ca2-adf9-200f903e0a7d"), "Administrator", null, new DateTime(2020, 9, 15, 8, 54, 8, 348, DateTimeKind.Local).AddTicks(8054), null, new DateTime(2020, 9, 15, 8, 54, 8, 348, DateTimeKind.Local).AddTicks(8376), null, "123456", 1, "超级管理员" });
        }
